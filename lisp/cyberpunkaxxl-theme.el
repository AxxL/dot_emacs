;;; cyberpunkaxxl-theme.el --- Cyberpunk Axxl Color Theme

;; adjusted by https://github.com/axxl
;; Copyright 2012-2013, Nicholas M. Van Horn

;; Author: Nicholas M. Van Horn <vanhorn.nm@gmail.com>
;; Keywords: color theme cyberpunkaxxl
;; Version: 20131117.1852
...
(deftheme cyberpunkaxxl "The Cyberpunkaxxl color theme")
...
;;    `(org-checkbox ((,class (:background ,cyberpunk-gray-2 :foreground ,cyberpunk-black )))) ; :box (:line-width 1 :style released-button)
   `(org-date ((,class (:foreground ,cyberpunk-blue-7 :underline t))))
   `(org-done ((,class (:bold t :weight bold :foreground ,cyberpunk-green
                              :box (:line-width 1 :style none)))))
   `(org-todo ((,class (:bold t :foreground ,cyberpunk-orange :weight bold )))) ; :box (:line-width 1 :style none)
